...
7. WHEN AI generates meal plans or recommendations THEN the system SHALL provide responses in the user's selected language with culturally appropriate context
